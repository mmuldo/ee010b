...
; number of calls to the PlayNote and ReadEEROM functions to test them.
;
; User Interface
; --------------
; speaker
...
; Routines
; --------
; Start: main function (calls tests)
; EEROMSoundTest: test the homework sound and EEROM functions
;
; Data Memory
; -----------
; TopOfStack: specifies the initial stack pointer, and consequently that
;       the stack depth is 128 bytes
; ReadBuffer: buffer for data read from the EEROM
; CompareBuffer: buffer containing the expected data from the EEROM
;
; Error Handling
; --------------
; none
...
;                                          values
;    6/03/22  Matt Muldowney            added Start routine, which contains 
;                                               initialization
...
; Description
; -----------
; main function: intializes a bunch of stuff and calls test functions
;
...
.dseg
	        ...
	        .byte 127
; intial stack pointer starting position
; total stack depth is 128 bytes
TopOfStack:	.byte 1
